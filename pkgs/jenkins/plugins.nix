...
# Command: jenkins4nix antisamy-markup-formatter console-column-plugin console-tail copyartifact credentials credentials-binding dashboard-view environment-dashboard external-monitor-job extra-columns ghprb git git-parameter github github-oauth google-login google-oauth-plugin jenkinswalldisplay jquery log-command mailer mapdb-api matrix-auth matrix-project nested-view oauth-credentials plain-credentials promoted-builds rebuild s3 script-security show-build-parameters simple-theme-plugin slack ssh-agent ssh-credentials ssh-slaves timestamper token-macro workflow-step-api
{
  ...
  "ghprb" = {
    version = "1.20";
    sha1 = "338d094dea02937e92a8166b9f3b45e5d64d2d9c";
