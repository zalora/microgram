...
rec {
  ...
  nixpkgs-config = {
    ...
    packageOverrides = pkgs: rec {
      inherit (ugpkgs) imagemagick go docker;
  ...
  exports = rec {
    inherit (pkgs)
      ...
      memcached
      netcat-openbsd nfs-utils nix nodejs ntp
    ...
    inherit (ugpkgs)
      ...
      newrelic-memcached-plugin newrelic-mysql-plugin newrelic-plugin-agent newrelic-sysmond nginx
