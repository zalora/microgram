...
let
  ...
  mysqlInstallPath = (pkgs.lib.callPackageWith pkgs ./default.nix {});
...

{
  ...
  config = mkIf config.services.mariadb.enable {
    ...
    systemd.services.mysql =
      { description = "MySQL Server";
        ...
        preStart =
          ''
            ...
            if ! test -e ${cfg.dataDir}/mysql; then
                ...
                ${mysql}/bin/mysql_install_db --defaults-extra-file=${myCnf} ${mysqldOptions}
        ...
        serviceConfig.TimeoutStopSec = 0;
